...
function ProfileModalWindow() {
  ...
  return (
    <div>
      <button type='button' onClick={() => setVisible(true)} style={{ background: "none", border: "none" }} className="mr-2">
      ...
      <Sidebar visible={visible} onHide={() => setVisible(false)} style={{ background: 'white', padding: '15px 10px 15px 10px' }}>
        <Profile me={me} />
      </Sidebar>
